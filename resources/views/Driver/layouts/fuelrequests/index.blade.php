...
@section('main-contents')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('Driver-fuelrequests.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Fuel Request"><i class="fas fa-plus"></i> Add Fuel Request</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($fuelrequest as $fuelrequests)
                <tr>
                    ...
                    <td>
                        @if($fuelrequests->HOD_approval == 'active')
                            <span class="badge badge-success">Approved</span>
                        @elseif($fuelrequests->HOD_approval == 'inactive')
