...
$fuelrequest = fuelrequest::where(['user_id'=>auth()->user()->id])->get();//->with(['vehicles','user'])->get();
    ...
    public function create()
    {
        ...
        return view('Driver.layouts.fuelrequests.create')->with('vehicle',$vehicle)->with('department',$department);;//->with('brands',$brand);;
    ...
    public function edit($id)
    {
        ...
        if ($fuelrequests) {
            ...
            return view('Driver.layouts.fuelrequests.edit')->with('fuelrequests',$fuelrequests)->with('vehicle',$vehicle);
